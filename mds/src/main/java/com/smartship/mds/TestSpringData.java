...
import com.smartship.mds.springdata.services.AddressService;
...
public class TestSpringData {
  ...
  public void savePerson() {
    ...
    // Deleting records
	/*
	 * personList.forEach( p -> { try { personService.deletePerson(p);
	 * log.info("DELETING RECORD " + p.getFirstName()); } catch
	 * (GenericServiceException e) { log.error("Error in deleting Person by id"); }
	 * });
	 */
  }
}
