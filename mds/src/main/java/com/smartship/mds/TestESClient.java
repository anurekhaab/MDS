...
import com.smartship.mds.es.documents.Person;
import com.smartship.mds.es.documents.Vehicle;
import com.smartship.mds.es.services.PersonSearchService;
import com.smartship.mds.es.services.VehicleSearchService;
...
public class TestESClient {
  ...
  @Autowired private VehicleSearchService vehicleSearchService;
  ...
  public void searchData() {
    ...
    vehicleSearchService.findByStringQuery(
        "Model S",
        "model",
        "createdDate",
        LocalDateTime.now().minusDays(2).toDate().getTime(),
        LocalDateTime.now().plusDays(2).toDate().getTime(),
        true);
  }
}
